    ...
    <DialogContent onInteractOutside = {(e)=>e.preventDefault()}
        ...
        >
            ...
            <div className='h-[90vh] bg-white p-3 rounded shadow'>
                <DialogHeader>
                    <DialogTitle className='h-8 border-b '>
                            Media Selection
                    </DialogTitle>
                </DialogHeader>
                ...
                <div className='h-[calc(100%-80px)] overflow-auto py-2'>
                    {
                        ...
                        (<div className='size-full flex justify-center items-center'>
                            <Image src={loading.src} height={80} width={80} alt="loading" priority="true" />
                        </div>)
                        :
                        isError ? 
                        <div className='size-full flex justify-center items-center'>
                ...
                <div className='h-10 pt-3 border-t flex justify-between'>
                    <div>
                        <Button type="button" onClick={handleClear} className="cursor-pointer">Clear All</Button>
                    </div>
